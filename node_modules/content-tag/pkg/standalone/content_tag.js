...
const PreprocessorFinalization = new FinalizationRegistry(ptr => wasm.__wbg_preprocessor_free(ptr >>> 0));
/**
*/
export class Preprocessor {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(Preprocessor.prototype);
        obj.__wbg_ptr = ptr;
        PreprocessorFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    */
    constructor() {
        ...
        return Preprocessor.__wrap(ret);
    }
    /**
    * @param {string} src
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_Error_58015c683709e145 = function(arg0) {
        const ret = Error(takeObject(arg0));
        return addHeapObject(ret);
    };
    imports.wbg.__wbg_parse_181a91d066d1f7fe = function(arg0) {
        const ret = JSON.parse(takeObject(arg0));
        return addHeapObject(ret);
    };
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('content_tag_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
